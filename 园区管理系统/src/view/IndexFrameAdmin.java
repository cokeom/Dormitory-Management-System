...
//				listStudentFrame = null;
		...
		mntmNewMenuItem_1_1_2.setIcon(new ImageIcon(IndexFrameAdmin.class.getResource("/image/电费.png")));
		...
		mntmNewMenuItem_1_1_2_1.setIcon(new ImageIcon(IndexFrameAdmin.class.getResource("/image/楼层.png")));
