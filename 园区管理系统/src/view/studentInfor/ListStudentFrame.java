...
public class ListStudentFrame extends JInternalFrame {
	...
	public ListStudentFrame() {
		...
		btnNewButton.setIcon(new ImageIcon(ListStudentFrame.class.getResource("/image/搜 索.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(ListStudentFrame.class.getResource("/image/重置.png")));
		...
		editButton.setIcon(new ImageIcon(ListStudentFrame.class.getResource("/image/编辑.png")));
		...
		deleteButton.setIcon(new ImageIcon(ListStudentFrame.class.getResource("/image/删 除.png")));
