...
public class UpdatePdNameFrame extends JInternalFrame {
	private JTextField oldNameText;
	private JTextField newNameText;

	/* Create the frame.
	 */
	public UpdatePdNameFrame() {
		...
		JLabel lblNewLabel = new JLabel("楼栋名字修改");
	...
	protected void confirmButton(ActionEvent ae) {
		...
		JOptionPane.showMessageDialog(this,pbuildingDao.updateName(oldName,newName));
		setVisible(false);
	}
